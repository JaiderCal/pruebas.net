$(function () {
    sideNavBarActions();
    //menuActions();
    //adjustHeightOfSideNavBar();
    menuCloseActions();
    mobileSideNavActions();
});


menuActions = function () {
    //$('.side_menu').on('click', '.side_nav_home', function (event) {
    //    $(location).attr('href', '/Home');
    //});

    //$('.side_menu').on('click', '.side_nav_request', function (event) {
    //    $(location).attr('href', '/MyRequests');
    //});

    //$('.side_menu').on('click', '.side_nav_activities', function (event) {
    //    $(location).attr('href', '/MyActivities');
    //});

    //$('.side_menu').on('click', '.side_nav_help', function (event) {
    //    $(location).attr('href', '/KnowledgeBase');
    //});
}

mobileSideNavActions = function () {
    var width = $(window).width();
    if (width < 786) {
        $('body').find('.side_nav_bar_expand .side_nav_apps span.icon-GlobalNavButton').addClass("move_right").removeClass("icon-pos");
    } else {
        $('body').find('.side_nav_bar_expand .side_nav_apps span.icon-GlobalNavButton').removeClass("move_right").addClass("icon-pos");
    }
}

menuCloseActions = function () {
    $(document).on('click', function (event) {
        $('.side_nav_bar_expand').hide();
    });
}
...
sideNavBarActions = function () {
    $('body').on('click', '.side_nav_apps', function (event) {
        event.stopPropagation();
        $('.side_nav_bar_expand').toggle();
        var width = $(window).width();
        if (width < 786) {
    ...
    $('.side_nav_apps').keydown(function (event) {
...
//adjustHeightOfSideNavBar = function (e) {
//    var viewPortHeight = e.target.outerHeight;
//    $('.side_nav_bar').height(viewPortHeight);
//    $('.side_nav_bar_expand').height(viewPortHeight);
//}
// SIG // Begin signature block
// SIG // MIIduAYJKoZIhvcNAQcCoIIdqTCCHaUCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFHRYBJvulW7I
// SIG // kJA7JQ+lrYT+Yu5MoIIYajCCBNowggPCoAMCAQICEzMA
...
// SIG // IwYJKoZIhvcNAQkEMRYEFBuCczSVEdFhtUPie1vmo/dB
// SIG // QclZMG4GCisGAQQBgjcCAQwxYDBeoECAPgBTAHkAcwB0
...
// SIG // AQBVLIB6Ib085XmRqXwVSHfs76tObR8+zjVh1Bv4jA8q
// SIG // CTeaLpseiDdCxi6dnmiUKurE7QLW1Zykfx7iw8Y5hPbs
// SIG // NlbLKO1JqAfjW7pJRvvcUlM6RY0PlCdOjTmbZglR8Q2b
// SIG // fMoWGTzeNbCrzpmW88iXSO7MskU9NUNLDl5T6SYVKYpG
// SIG // SXlqNluCgvIq4A2mRzYTu0bXqAyWqmwvYTjLC8r78lEE
// SIG // CTyTL30HY2RZthEfgLyqDyQjeS+607rB0kK6KanxHmPs
// SIG // WR28qYJQEKohFK4xioKEVZ1d9aH7PaoYX3SojQ7pP4lr
// SIG // DCEZd7K5D6LdBXzNgRkMCSQiGiK86SjI0x6qoYICKDCC
// SIG // AiQGCSqGSIb3DQEJBjGCAhUwggIRAgEBMIGOMHcxCzAJ
// SIG // BgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAw
// SIG // DgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3Nv
// SIG // ZnQgQ29ycG9yYXRpb24xITAfBgNVBAMTGE1pY3Jvc29m
// SIG // dCBUaW1lLVN0YW1wIFBDQQITMwAAASDzON/Hnq4y7AAA
// SIG // AAABIDAJBgUrDgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsG
// SIG // CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkwMTI4
// SIG // MTkwNzA1WjAjBgkqhkiG9w0BCQQxFgQUni0vnYpSr4DO
// SIG // qsGq2E16wpFV+YUwDQYJKoZIhvcNAQEFBQAEggEAigSd
// SIG // +37DVAIl2nMvqtulx6qMum20XnBsTU6eg27ayehhQ89r
// SIG // QhEr32TT5NKDAVhSHorXild/WIn37dzgWgv/UIM241rD
// SIG // iQ7zlsUUiZVU82YUvBNp4+kPrWVzVayovzEBilYJkS+H
// SIG // 69TTHAEHJ14vgMwlzyRJFXbsgA/PB/w9Ls+D6cTdSrNF
// SIG // Owok41lJGcEIrM9TyqMNegW06hB7ZXSomX9V4VLZ+MIo
// SIG // izGge7Fy5XQbl5cvTsRcextfXBscr1BTqORazY9L8egJ
// SIG // TXUvjF8Gm4Km2B6EywmMbk4FfCuWobIR87Qksd3i5gLL
// SIG // INBApvL6oXMyLG29nII/62ogvbZPVw==

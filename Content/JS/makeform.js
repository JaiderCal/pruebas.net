...
var backHomeNav = function () {
    $('.fav_div_container').on('click','.back_home_nav', function (event) {
        $(location).attr('href', '/Home');
    });
}
var submitMakeFormActions = function () {
    $('.fav_div_container').on('click','form#submitButton').click(function (event) {
        $(this).submit();
    });
}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFH5guZmXK/uh
// SIG // q2hQPHAeIhvzih3CoIIYajCCBNowggPCoAMCAQICEzMA
...
// SIG // IwYJKoZIhvcNAQkEMRYEFP2FGwDYJhjRR9hu0Yr7+NLO
// SIG // HU/1MG4GCisGAQQBgjcCAQwxYDBeoECAPgBTAHkAcwB0
...
// SIG // AQB+03/ZvA1RArcGxacUM02trRvXrhVi9FuXwUyOq30x
// SIG // UvQWa4Zf9jFmbCfOgeufJRI2WnGr+zY8RIYmt5P77KN8
// SIG // RU0ME4BXXKDq6B1K+p9MJsd+2IZWFoPNbswLThzxX5X6
// SIG // gf8E2lzsLE1CS6MB0e6WSzUndk/pJAoeXJhgZsy5Lg1N
// SIG // aMQqfzsbwSQle/bkcqECNhSN6EKPo+904FiKQlexvSoE
// SIG // w+00nckC9JRvrJrHvjI/E+v+HT5t5hhj2uU3CiphimCd
// SIG // cKsOJgNU9Ez1rfjnzB44tkeYCxXZ3Nm1Vf+NiQHlim/2
// SIG // 3uWTt3VEpCheHjLvsXzZofzQlVcj5lPFccImoYICKDCC
...
// SIG // MTkwNjA4WjAjBgkqhkiG9w0BCQQxFgQUSiPwQycWAmvr
// SIG // BCh3m8CJtMBVKQgwDQYJKoZIhvcNAQEFBQAEggEAlhH0
// SIG // 3mcAdFJhWL4khNw7/MbwyPD1AUtlQOhS3EFZBe4OJzwX
// SIG // FS/fRS/t6FeBWxcoHg7DvVeieUMhTXANazX6GKWvIDoV
// SIG // 30cOBsjqi0h8yEEYYZvYhWL4iMTAvtOHpINY7CenClrP
// SIG // s8nu8hdZtPyCK8IsZGqFJ7yLQUjPmbY/SEXiRHF7Fp6t
// SIG // TDNTrzcucoYS2n7SdQN2kOEb1gQkMu8MjdZuumv64SeW
// SIG // 198+bsoVs2o3K323pGcsOiRSjyuFGRMHJ9utlrsAinMJ
// SIG // B7j9BHgaVoCMd1Nt42Og+gmTCpTS96kwHfPrNGsjhVQ5
// SIG // /bw2BOJsrXNQ6MXa/1eTxo1ooQZUkg==

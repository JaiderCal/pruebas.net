...
var tossNotifCloseAction = function (notifDiv, callback) {
    notifDiv.on('click', '.toss_notification_close', function (event) {
        notifDiv.remove();
        tosspageLoaderAction('hide');
        callback();
    })
}

var showTossNotification = function (content, callback) {   
    tosspageLoaderAction('show');
    var notifDiv = $('.toss_notification').clone();
    notifDiv.find('.toss_notification_content').text(content);
    $('.top_bar').append(notifDiv);
    tossNotifCloseAction(notifDiv, callback);
    notifDiv.slideDown().delay(3000).fadeOut("slow", function () {
        $(this).remove();
        tosspageLoaderAction('hide');
        callback();
    });
...
tosspageLoaderAction = function (action) {
    var docHeight = $(document).height();
    var overlayDiv = $("<div class='toss_notification_body'></div>").height(docHeight);
    if (action == 'show') {
        $("body").append(overlayDiv);
       
    } else {
      
        $("body .toss_notification_body").remove();
    }
}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFH557wH/uLDY
// SIG // tLVUZFSeJIRUt9+ToIIYajCCBNowggPCoAMCAQICEzMA
...
// SIG // IwYJKoZIhvcNAQkEMRYEFJwtplbZ7NWI9pxz6RQ9zCYS
// SIG // VXPNMG4GCisGAQQBgjcCAQwxYDBeoECAPgBTAHkAcwB0
...
// SIG // AQAa3CS1WXKn5yVYo1Emh6PXFufTt+9ZMybHzQDPdSqF
// SIG // fgh5zmOQm2LYhcNkgzzanTxz9g0cz6Al13I92Y/AYePa
// SIG // zjV8jB/jjEcF6g1KnYq2E1/tQE/zT2Lw+VLVVryU09nq
// SIG // LeG2S9iiBV+tdZ9Zs1fs3eSxoQ/tjcuZuIEOh5iW8+c1
// SIG // UV5C9zgoqi28r/kq74rC9CPuc754DE3CeUTHlHW1BV/2
// SIG // Lga1cWH11kqjsL3oplY9FjZyZ95X/ecRtal9Cb5cTdDX
// SIG // tH/FfbV9M2W4Ya733M/r2DbiWwyX4Ug0eMu6dDJfrO5j
// SIG // LqUxW4NzCAVLFmoC5QB8etYwOrIsG1R/r7/5oYICKDCC
// SIG // AiQGCSqGSIb3DQEJBjGCAhUwggIRAgEBMIGOMHcxCzAJ
// SIG // BgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9uMRAw
// SIG // DgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3Nv
// SIG // ZnQgQ29ycG9yYXRpb24xITAfBgNVBAMTGE1pY3Jvc29m
// SIG // dCBUaW1lLVN0YW1wIFBDQQITMwAAAQJSCNjfQc3ntgAA
// SIG // AAABAjAJBgUrDgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsG
// SIG // CSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkwMTI4
// SIG // MTkwNjA1WjAjBgkqhkiG9w0BCQQxFgQU1czYA39rZ2Hp
// SIG // YSXeIQsgbTjWjW0wDQYJKoZIhvcNAQEFBQAEggEASkj3
// SIG // pVB8sSSyZMI5+W3sb/4hYIreXrbixH6xhVEQjF+46EAP
// SIG // fD+J7YhCmmN5Bvk589vdn/YiSK1n5oXcdRAgzBmwUlD/
// SIG // +ITXsF9yMk891TKMjYZdxCdoMd3obZuPS+KbQAJ1AslW
// SIG // FB8ASjtLkSdEHujHq+Ka+eiI0H0RqsRIJjtAAhpA1Ez3
// SIG // s4exy6ZPr2XWBMEnDYANWK90br13ebFs1N/CTn2cj/Kp
// SIG // FqqYdTdqm7EWLc9jU73qaRE+9dwW7Ypu5bS7+tbBGszp
// SIG // dgmVrAy/Ju332ZsQA8nGVQUWwu1VNCYb8bSz0WfDdx4q
// SIG // PzItPRCgr//KIhC5+2OFNB9wqjFnpQ==
